...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="check();">查看</a></li>
...
<li id="new"><a href="#" onclick="formSubmit('1/start.action','_self');this.blur();">启用</a></li>
<li id="new"><a href="#" onclick="formSubmit('0/stop.action','_self');this.blur();">停止</a></li>
