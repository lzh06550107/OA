...
public class Contract {
	...
	public String toString() {
		return "Contract [id=" + id + ", contractNo=" + contractNo
				+ ", offeror=" + offeror + ", printStyle=" + printStyle
				+ ", customName=" + customName + ", signingDate=" + signingDate
				+ ", inputBy=" + inputBy + ", checkBy=" + checkBy
				+ ", inspector=" + inspector + ", shipTime=" + shipTime
				+ ", deliveryPeriod=" + deliveryPeriod + ", importNum="
				+ importNum + ", tradeTerms=" + tradeTerms + ", crequest="
				+ crequest + ", remark=" + remark + ", contractProducts="
				+ contractProducts + "]";
	}
