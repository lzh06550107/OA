				...
				<div class="ItemBlock">
					<table class="mainForm">
						<tr>
							...
							<td>
								<!-- name对应着department对象的parentId字段 --> <s:select
									cssClass="SelectStyle" name="parentId" list="departmentList"
									listKey="id" listValue="name" headerKey="" headerValue="请选择部门"></s:select>
							</td>
						</tr>
						<tr>
							<td>部门名称</td>
