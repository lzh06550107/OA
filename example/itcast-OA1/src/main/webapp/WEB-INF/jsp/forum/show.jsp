...
<div id="MainArea">
	...
	<center>
		...
		<div class="ForumPageTableBorder">
				...
				<tbody class="dataContainer" datakey="topicList">
					<s:iterator value="recordList">
						<tr height="35" id="d0" class="template">
							...
							<td class="Topic">
								<s:a class="Default" action="topic_show?id=%{id}">${title}</s:a>
							</td>
			...
			<s:hidden name="id"></s:hidden><!-- 板块id -->
			<div id="TableTail">
				<div id="TableTail_inside">
					<table border="0" cellspacing="0" cellpadding="0" height="100%" align="left">
						<tr valign=bottom>
							<td></td>
							<td>
								<s:select list="#{'0':'全部主题','1':'全部精华帖'}" name="viewType" />
								<s:select list="#{'0':'默认排序（按最后更新时间排序，但所有置顶帖都在前面）','1':'按最后更新时间排序','2':'按主题发表时间排序','3':'按回复数量排序'}"
											name="orderBy" />
								<s:select list="#{'false':'降序','true':'升序' }" name="asc"/>
