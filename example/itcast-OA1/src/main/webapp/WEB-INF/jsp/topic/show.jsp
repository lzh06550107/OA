...
<div id="MainArea">
	...
	<center>
		...
		<div class="ForumPageTableBorder dataContainer" datakey="replyList">
			...
			<!-- ~~~~~~~~~~~~~~~ 显示主帖 ~~~~~~~~~~~~~~~ -->
			<s:if test="currentPage == 1"><!-- 只在第一页显示楼主 -->
			<div class="ListArea">
						...
						<tr><!--显示楼层等信息-->
							<td class="Footer" height="28" align="center" valign="bottom">
								<ul style="margin: 0px; width: 98%;">
									...
									[
										<s:property value="(currentPage-1)* pageSize + #s.count"/><!-- 注意修改楼层数 -->
									楼]</font>
										<s:date name="postTime" format="yyyy-MM-dd HH:mm:ss"/>
									</li>
									<li style="float: right;"><a href="javascript:scroll(0,0)">
		...
		<!--分页信息-->
		<!-- 表单收集需要提交的信息，包括当前主题id,当前页号 -->
		<s:form id="pageForm" action="topic_show" namespace="/">
			<s:hidden name="id"></s:hidden><!-- 从action中获取 -->
			<!-- 其它需要动态获取的，则从表单其它控件获取 -->
		</s:form>
