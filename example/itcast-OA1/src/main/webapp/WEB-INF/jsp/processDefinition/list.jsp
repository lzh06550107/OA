...
<head>
	...
	<script type="text/javascript">
		function showImage(id){
			//IE浏览器中传递参数出现乱码
			var id = window.encodeURI(encodeURI(id));
			var url = "${pageContext.request.contextPath}/processDefinition_showImage.action?id=" + id;
			window.showModalDialog(url,"","dialogHeight:400px;dialogWidth:500px;dialogLeft:500px;dialogTop:200px");
		}
	</script>
</head>
<body>
